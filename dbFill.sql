insert into news values (1,'Taras Plavin','Football','Championship, IT, startup','websolutions, football3x3','News 1','Shord description 1', 'Shot mazafaka', LOAD_FILE('c:/Downloads/2.jpg'), NOW());
